...
| 원천 문서 | `PRD/archive/PRD_CardFit_v1.0.md` (본 SRS는 이 PRD를 요구사항 도출의 유일한 정보 원천으로 한다) |
...
![CardFit Use Case Diagram](../../PRD/archive/diagrams/usecase_diagram_cardfit_v0.1.png)

> 이미지 파일: `PRD/archive/diagrams/usecase_diagram_cardfit_v0.1.png` (벡터 원본: `PRD/archive/diagrams/usecase_diagram_cardfit_v0.1.svg`)
