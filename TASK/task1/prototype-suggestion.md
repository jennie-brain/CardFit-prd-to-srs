...
이 절은 `grill-it` 인터뷰에서 나온 질문을 그대로 기능으로 확정하지 않고, PRD·SRS·TASK의 기존 경계와 대조해 프로토타입 착수 결론으로 좁힌 과정이다. 상세 토픽 상태와 반영 파일은 [`docs/grill/GRILL_LEDGER.md`](../../docs/grill/GRILL_LEDGER.md), 화면별 명세는 [`prototype-visual-spec.md`](prototype-visual-spec.md)를 따른다.
