...
# GitHub Project 용 TASK — TEST-003 근거·AI·스코프·정렬 테스트

## Summary
- 목적: 설명 가능성과 실행 대행 경계, 선택적 AI 장애, Could 정렬을 자동 검증한다.
...
- [ ] Gemini timeout·429·5xx fallback을 테스트한다.
...
- [ ] 정상·거부·AI 장애·금지 문구 suite가 green이다.
