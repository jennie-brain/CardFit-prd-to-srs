...
| 원천 문서 | `SRS_CardFit_v1.1.md`(직전 기준선), `docs/product/PRD_CardFit_v1.0.md`, `team-project_2nd/master-deck`, C-TEC-001~007 |

> 📘 **HTML 버전**: `docs/technical/SRS_CardFit_v1.2.html`
