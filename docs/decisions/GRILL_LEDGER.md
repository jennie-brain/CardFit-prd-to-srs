...
- 참조 범위: `docs/product/PRD_CardFit_v1.3.md`, 계획 정본 `docs/tasks/task1/prototype-suggestion.md` 19건, `docs/tasks/task2`의 연결 TASK
- 관심 방향: 프로토타입 시각화 계획의 미확정 사항 (화면·상태·데이터·문구·타입 경계)
- 완료 조건: 아래 토픽 전부 `RESOLVED`
- OUTPUT: 시각화 계획 정본 `docs/tasks/task1/prototype-visual-spec.md` + 관련 TASK 문서 + 에이전트 하네스
...
- [x] T4 | CORE  | UI가 바인딩할 타입 원천 — SPEC-001 미확정 상태의 ViewModel 처리 | status:RESOLVED | decision:`features/cardfit-prototype/lib/view-model.ts` 단일 진입점 + 기능별 ViewModel + 공통 상태 타입 | applied:docs/tasks/task1/prototype-visual-spec.md §4, .agents/rules/006
- [x] T5 | CORE  | Fixture 위치·형식과 상태 전환 조작 수단(상태 스위처) | status:RESOLVED | decision:`features/cardfit-prototype/fixtures/*.ts` + 상태별 URL + `review=1` 검토자 전용 패널 | applied:docs/tasks/task1/prototype-visual-spec.md §5, .agents/rules/006
- [x] T6 | CORE  | 상태 언어 7종(loading·empty·partial·stale·error·unavailable·success) 한글 카피 확정 범위 | status:RESOLVED | decision:대표 제목·의미·CTA 확정 + 일반 안내 해요체/조건·고지 합니다체 | applied:docs/tasks/task1/prototype-visual-spec.md §6, docs/tasks/task2/UX-001 Decision Log, .agents/rules/006
- [x] T7 | CORE  | 스코프 고지·금지어 문구 원천 (COMMAND-008 미포함 상태, GR4 직결) | status:RESOLVED | decision:PRD 기반 후보 고지 3종 + 금지 표현 고정, `COMMAND-008` 승인 시 교체 | applied:docs/tasks/task1/prototype-visual-spec.md §7, docs/tasks/task2/UI-002·UX-004·UI-007 Decision Log, .agents/rules/006
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §1 신설 · `.agents/rules/006-prototype-visual-scope.md` 신설 · `CLAUDE.md` 세부 규칙 표에 006 행 추가
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §3 신설 · `.agents/rules/006`에 라우팅 규칙 추가
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §4 신설 · `.agents/rules/006`의 ViewModel 경로·구성 규칙 구체화
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §5 신설 · `.agents/rules/006`에 Fixture·검토 모드 규칙 추가
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §6 신설 · `docs/tasks/task2/UX-001` Decision Log · `.agents/rules/006` 상태 언어 규칙
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §7 신설 · `docs/tasks/task2/UI-002·UX-004·UI-007` Decision Log · `.agents/rules/006` 스코프 고지 규칙
...
- 반영: `docs/product/PRD_CardFit_v1.3.md` US-D AC4 정정 · `docs/tasks/task1/prototype-visual-spec.md` §8 신설 · `docs/tasks/task1/04_정책_결정_로그.md` DECISION-004 · `docs/tasks/task2/UX-002·UI-003` Decision Log · `.agents/rules/006` 입력 초기값 규칙
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §8.3~8.6 · `docs/tasks/task2/UX-002·UI-003` Decision Log · `.agents/rules/006` 입력 조작 규칙
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §8.8 · `docs/tasks/task1/04_정책_결정_로그.md` DECISION-005 · `docs/tasks/task2/UX-002·UI-003` Decision Log · `.agents/rules/006`
...
- 반영: `docs/product/PRD_CardFit_v1.3.md` F-01·US-F AC2·FutureSpendPlan · `docs/technical/SRS_CardFit_v1.6_GPT-5.6-SOL.md` REQ-FUNC-001A/B·FutureSpendPlan · `docs/tasks/task1/prototype-visual-spec.md` §8.9 · `docs/tasks/task1/04_정책_결정_로그.md` DECISION-006 · `docs/tasks/task2/UX-002·UI-003` Decision Log · `.agents/rules/006`
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §8.10 · `docs/tasks/task1/04_정책_결정_로그.md` DECISION-007 · `docs/tasks/task2/UX-002·UI-003` Decision Log · `.agents/rules/006`
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §9 · `docs/tasks/task1/prototype-suggestion.md` Decision Log · `docs/tasks/task2/UX-003·UI-005` Decision Log · `.agents/rules/006`
...
- 반영: `docs/tasks/task1/prototype-visual-spec.md` §10 · `docs/tasks/task1/prototype-suggestion.md` 결정 과정·Decision Log · `docs/tasks/task2/UX-004·UI-006` Decision Log · `.agents/rules/006`
