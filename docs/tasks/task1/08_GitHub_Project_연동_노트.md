...
- 이슈 본문은 `docs/tasks/task2/<TASK-ID>.md`의 원문에 `docs/tasks/task1/03_병렬실행_Gantt_로드맵.md`(압축 수행 계획) 기준 트랙·레인·시작일·종료일·임계 경로 여부·선행/후행 TASK 표를 상단에 삽입해 생성했다.
...
- `docs/tasks/task1/03_병렬실행_Gantt_로드맵.md`
- `docs/tasks/task2/*.md`
